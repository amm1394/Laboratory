...
{
    public partial class RegisterNopaymentsForView : RASF.General.Forms.Base.DockContentForm
    {
        public RegisterNopaymentsForView()
        {
            InitializeComponent();
        ...
        private void FillGrid()
        {
            ...
            this.registerNopaymentsForViewList1.Fill();
            this.grdIsHold.Refetch();
        }

        private void btnSave_Click(object sender, EventArgs e)
        {
            this.grdIsHold.ExportToExcel("مجهول الوصول");
