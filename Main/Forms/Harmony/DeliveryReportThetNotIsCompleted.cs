...
{
    public partial class DeliveryReportThetNotIsCompleted : RASF.General.Forms.Base.DockContentForm
    {
        public DeliveryReportThetNotIsCompleted()
        {
            InitializeComponent();
            this.contracts_IsHoldList1.spName = "DeliveryReportThetNotIsCompleted";
        }
