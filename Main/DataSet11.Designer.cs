...
namespace Main.DataSet1TableAdapters {
    ...
    public partial class AppointmentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [LaboratoryRASF].[dbo].[Appointments] ([Type], [StartDate], [EndDate], [AllDay], [Subject], [Location], [Description], [Status], [Label], [ResourceID], [ResourceIDs], [ReminderInfo], [RecurrenceInfo], [TimeZoneId], [CustomField1]) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("TimeZoneId", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "TimeZoneId", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [LaboratoryRASF].[dbo].[Appointments] SET [Type] = ?, [StartDate] = ?, [EndDate] = ?, [AllDay] = ?, [Subject] = ?, [Location] = ?, [Description] = ?, [Status] = ?, [Label] = ?, [ResourceID] = ?, [ResourceIDs] = ?, [ReminderInfo] = ?, [RecurrenceInfo] = ?, [TimeZoneId] = ?, [CustomField1] = ? WHERE (([UniqueID] = ?) AND ((? = 1 AND [Type] IS NULL) OR ([Type] = ?)) AND ((? = 1 AND [StartDate] IS NULL) OR ([StartDate] = ?)) AND ((? = 1 AND [EndDate] IS NULL) OR ([EndDate] = ?)) AND ((? = 1 AND [AllDay] IS NULL) OR ([AllDay] = ?)) AND ((? = 1 AND [Subject] IS NULL) OR ([Subject] = ?)) AND ((? = 1 AND [Location] IS NULL) OR ([Location] = ?)) AND ((? = 1 AND [Status] IS NULL) OR ([Status] = ?)) AND ((? = 1 AND [Label] IS NULL) OR ([Label] = ?)) AND ((? = 1 AND [ResourceID] IS NULL) OR ([ResourceID] = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("TimeZoneId", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "TimeZoneId", global::System.Data.DataRowVersion.Current, false, null));
    ...
    public partial class ResourcesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [LaboratoryRASF].[dbo].[Resources] WHERE (([UniqueID] = ?) AND ([Reso" +
                "urceID] = ?) AND ((? = 1 AND [ResourceName] IS NULL) OR ([ResourceName] = ?)) AN" +
            ...
            this._adapter.InsertCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [LaboratoryRASF].[dbo].[Resources] ([ResourceID], [ResourceName], [Co" +
                "lor], [Image], [CustomField1]) VALUES (?, ?, ?, ?, ?)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ResourceID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ResourceID", global::System.Data.DataRowVersion.Current, false, null));
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [LaboratoryRASF].[dbo].[Resources] SET [ResourceID] = ?, [ResourceName] = ?, [Color] = ?, [Image] = ?, [CustomField1] = ? WHERE (([UniqueID] = ?) AND ([ResourceID] = ?) AND ((? = 1 AND [ResourceName] IS NULL) OR ([ResourceName] = ?)) AND ((? = 1 AND [Color] IS NULL) OR ([Color] = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ResourceID", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ResourceID", global::System.Data.DataRowVersion.Current, false, null));
