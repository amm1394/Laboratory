...
{
    public partial class DeliveryDateChangeForHarmony : RASF.General.Forms.Base.DockContentForm
    {

        public DeliveryDateChangeForHarmony()
        {
            InitializeComponent();
            this.deliveryDateChangeList1.spName = "DeliveryDateChangeForharmony";
