...
namespace RASF.General.Lists
{
    ...
    public class ContractsBaseList : RASF.General.Lists.Base.BaseList<RASF.General.Data.Contracts_Base>
    {
        public ContractsBaseList()
        {
            this.spName = "Contracts_Base";
            this.list = new List<RASF.General.Data.Contracts_Base>();
            this.deletedlist = new List<RASF.General.Data.Contracts_Base>();

        }

        public ContractsBaseList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
        ...
        public int GetContractNo()
        {
            ...
            {
                Connection.Open();
                using (System.Data.SqlClient.SqlCommand Command = new System.Data.SqlClient.SqlCommand("GetContractNo", Connection))
                {
