...
{
    public partial class SendLettersReportForEdit : RASF.General.Forms.Base.DockContentForm
    {
        public SendLettersReportForEdit()
        {
            InitializeComponent();
        ...
        private void grdReports_ColumnButtonClick(object sender, Janus.Windows.GridEX.ColumnActionEventArgs e)
        {
            switch (e.Column.Key)
            {
                case "CompanyLetterNo":
                    RASF.Main.Forms.Secretariat.EditSendLetters EditSendLetters = new RASF.Main.Forms.Secretariat.EditSendLetters((Guid)(this.grdReports.CurrentRow.Cells["SendLettersCode"].Value));
                    EditSendLetters.Show();
                    break;
