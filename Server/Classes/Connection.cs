...
namespace RASF.Messaging.Server.Classes
{
    public class Server_Connection : RASF.Messaging.General.Classes.Connection
    {
        ...
        public void Intial()
        {
            ...
            this.IPAddress = System.Net.IPAddress.Parse("192.168.0.7");
        ...
        private void OnTimer(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            try
            {
                foreach (General.Classes.Client Client in Clients)
                {
                    Client.SendMessage(new General.Classes.Packet(Client.UserId, Guid.Empty, Guid.Empty, "", General.Enums.DataIdentifier.None));
                }
            }
            catch
            {
        ...
        {
            foreach (General.Classes.Client Client in Clients.Where(cl => cl.UserId == e.Packet.Reciver && cl.UserId != e.Packet.Sender))
            {
