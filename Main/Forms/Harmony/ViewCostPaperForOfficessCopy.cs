...
{
    public partial class ViewCostPaperForOfficessCopy : RASF.General.Forms.Base.DockContentForm
    {
        public ViewCostPaperForOfficessCopy()
        {
            InitializeComponent();
        ...
        public ViewCostPaperForOfficessCopy(Guid ContractsCode, int ContractNo)
            :this()
        {
