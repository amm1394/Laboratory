...
namespace RASF.Main.Controls.Reception
{
    public partial class Test_Control : UserControl
    {
        ...
        public RASF.General.Lists.MasterTestStatusList MASTERTESTSTATUSList
        {
            set
            {
                this.masterTestStatusList1 = value;
        ...
        private void chkTestName_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                foreach (RASF.General.Data.MasterTestStatus MasterTestStatus in this.masterTestStatusList1.list)
                {
      ...
      //      pnlGrid.Enabled = chkTestName.Checked;
        ...
        private void grdMaster_UpdatingCell(object sender, Janus.Windows.GridEX.UpdatingCellEventArgs e)
        {
           ...
           //     ((RASF.General.Data.MasterTestStatus)this.grdMaster.CurrentRow.DataRow).Priority = Convert.ToInt32(e.Value);//
        ...
        public void Reset()
        {
            ...
            foreach (General.Data.MasterTestStatus Test in this.masterTestStatusList1.list)
            {
                Test.IsCheck = false;
        ...
        public void Set(List<General.Data.MasterTestStatus> list)
        {
            if (list.Count > 0)
            {
                ...
                {
                    RASF.General.Data.MasterTestStatus test = this.masterTestStatusList1.Where(row => row.MasterTestCode == Test.MasterTestCode).FirstOrDefault();
                    test.IsCheck = true;
