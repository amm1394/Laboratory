...
{
    public partial class Mechanical : UserControl
    {
        ...
        public List<RASF.General.Data.MechanicalLabDelivery> DataSource
        {
            get { return this.mechanicalLabDeliveryList1.list; }
            set
            {
                if (value != null)
                {

                    this.mechanicalLabDeliveryList1.list.Clear();
                    this.mechanicalLabDeliveryList1.list.AddRange(value);

                    Int16 i = 1;
                    foreach (RASF.General.Data.MechanicalLabDelivery row in this.mechanicalLabDeliveryList1.list)
                    {
                        row.Radif = i++;
                    }

                    //this.label3.Text = this.mechanicalLabDeliveryList1.Count().ToString();
                    //this.label6.Text = this.mechanicalLabDeliveryList1.Where(row => row.Takhiri == true).Count().ToString();
        ...
        {
            List<RASF.General.Data.MechanicalLabDelivery> data = (from row in this.mechanicalLabDeliveryList1 select row).Take(23).ToList<RASF.General.Data.MechanicalLabDelivery>();
            this.mechanicalLabDeliveryList1.list.RemoveRange(0, data.Count());
        ...
        {
            if (this.mechanicalLabDeliveryList1.list.Count == 0)
            {
        ...
        {
            if ((DesignMode == false) && (this.grid1.RootTable != null))
            {
