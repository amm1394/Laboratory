...
{
    public partial class ReasonOfDntExportInvoiceForm : RASF.General.Forms.Base.DockContentForm
    {
        public ReasonOfDntExportInvoiceForm()
        {
            InitializeComponent();
        }
        ...
        private void FillGrid()
        {
            ...
            this.reasonOfDntExportInvoiceList1.Fill(Parameters);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                RASF.General.Data.Contracts_Base_Edit Current_Contract = (RASF.General.Data.Contracts_Base_Edit)this.grddilatory.SelectedItems[0].GetRow().DataRow;
                ...
                if ((Current_Contract != null) && (String.IsNullOrWhiteSpace(Current_Contract.Description) == false))
                {
                    ...
                    this.reasonOfDntExportInvoiceList1.Update();
