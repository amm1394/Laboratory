...
namespace RASF.General.Lists
{
    ...
    public class FinancialLaboratoryNumberOfTestsList : RASF.General.Lists.Base.BaseList<RASF.General.Data.FinancialLaboratoryNumberOfTests>
    {
        public FinancialLaboratoryNumberOfTestsList()
        {
            this.spName = "FinancialLaboratoryNumberOfTests";
        ...
        public FinancialLaboratoryNumberOfTestsList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
