...
namespace RASF.General.Lists
{
    ...
    public class FinancialLaboratoryNumberOfTestsExitedList : RASF.General.Lists.Base.BaseList<RASF.General.Data.FinancialLaboratoryNumberOfTests>
    {
        public FinancialLaboratoryNumberOfTestsExitedList()
        {
            this.spName = "FinancialLaboratoryNumberOfTestsExited";
        ...
        public FinancialLaboratoryNumberOfTestsExitedList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
