...
{
    public partial class New_Reciption_EditForAgency : RASF.Main.Forms.Reception.New_ReceptionForAgency
    {
        
        private Int16 ContractNo;
        public New_Reciption_EditForAgency(Guid contractid)
        {
            InitializeComponent();
           ...
           // txtReson.Enabled = true;
            ...
            foreach (RASF.General.Data.Parts_Master Parts in this.partsMasterList1.list)
            {
               ...
               // dropDownReportSendingTypeCode.SelectedValue = this.contractsBaseList1.list[0].ReportSendingTypeCode;
                ...
                this.CompaniesReportCode = this.contractsBaseList1.list[0].Company_Report;
