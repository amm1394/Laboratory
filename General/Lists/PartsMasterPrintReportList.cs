...
namespace RASF.General.Lists
{
    ...
    public class PartsMasterPrintReportList : RASF.General.Lists.Base.BaseList<RASF.General.Data.PartsMasterPrintReport>
    {
        public PartsMasterPrintReportList()
        {
            this.spName = "PartsMasterPrintReport";
        ...
        public PartsMasterPrintReportList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
