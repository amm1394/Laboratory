...
{
    public partial class UnKnown : UserControl, RASF.General.InterFaces.IRecieption
    {
        ...
        {
            Guid ReceiptAmount_Master = Insert_ReceiptAmount_Master.Update(CompanyId, 17, (Guid)drpCash.SelectedValue, Convert.ToInt32(nbReceiptAmount.Value.ToString()));
