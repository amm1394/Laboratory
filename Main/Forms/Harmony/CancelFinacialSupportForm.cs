...
{
    public partial class CancelFinacialSupportForm : RASF.General.Forms.Base.DockContentForm
    {
        public CancelFinacialSupportForm()
        {
            InitializeComponent();
        }
        ...
        {
            this.cancelFinacialSupportList1.Fill();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (this.grdIsHold.SelectedItems.Count > 0)
            {
                ...
                if ((Current_Contract != null) && (String.IsNullOrWhiteSpace(Current_Contract.Description) == false))
                {
                    ...
                    this.cancelFinacialSupportList1.Update();
