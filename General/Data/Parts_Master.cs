...
{
    public class Parts_Master : RASF.General.InterFaces.IRow
    {
        ...
        [System.ComponentModel.Category("RASF")]
        [RASF.General.Attributes.Validator("")]
        [RASF.General.Attributes.DataAttribute("تعداد جز", "")]
        public byte NumberOfDetail
        {
            get;
            set;
        }
        ...
        [System.ComponentModel.Category("RASF")]
        [RASF.General.Attributes.Validator("")]
        [RASF.General.Attributes.DataAttribute("تست در مجل", "")]
        public Boolean OnSiteTesting
        {
            get;
            set;
        }
        ...
        [System.ComponentModel.Category("RASF")]
        [RASF.General.Attributes.DataAttribute()]
        public RASF.General.Lists.MasterTestStatusList Tests
        {
            get;
            set;
        }
        ...
        public Parts_Master()
        {
            this.Tests = new Lists.MasterTestStatusList();
            this.Englishname = String.Empty;
        }

        public void CopyTest(RASF.General.Lists.MasterTestStatusList tests)
        {
