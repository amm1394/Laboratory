...
{
    public partial class DisCountOfIranMavad : UserControl, RASF.General.InterFaces.IRecieption
    {
        private RASF.Main.Classes.Insert_ReceiptAmount_Master Insert_ReceiptAmount_Master;
        public DisCountOfIranMavad()
        {
            InitializeComponent();
        }
        ...
        {
            return Insert_ReceiptAmount_Master.Update(CompanyId,13, (Guid)drpCash.SelectedValue, Convert.ToInt32(nbReceiptAmount.Value.ToString()));
        }
