...
namespace RASF.General.Lists
{
    ...
    public class FinancialLaboratoryNumberOfTestsDetailList : RASF.General.Lists.Base.BaseList<RASF.General.Data.FinancialLaboratoryNumberOfTests>
    {
        public FinancialLaboratoryNumberOfTestsDetailList()
        {
            this.spName = "FinancialLaboratoryNumberOfTestsDetail";
        ...
        public FinancialLaboratoryNumberOfTestsDetailList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
