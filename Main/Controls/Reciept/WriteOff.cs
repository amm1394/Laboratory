...
{
    public partial class WriteOff : UserControl, RASF.General.InterFaces.IRecieption
    {
        ...
        {
            return Insert_ReceiptAmount_Master.Update(CompanyId, 11, (Guid)drpCash.SelectedValue, Convert.ToInt32(nbReceiptAmount.Value.ToString()));
        }
