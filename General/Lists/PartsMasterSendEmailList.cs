...
namespace RASF.General.Lists
{
    ...
    public class PartsMasterSendEmailList : RASF.General.Lists.Base.BaseList<RASF.General.Data.PartsMasterPrintReport>
    {
        public PartsMasterSendEmailList()
        {
        ...
        public PartsMasterSendEmailList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
