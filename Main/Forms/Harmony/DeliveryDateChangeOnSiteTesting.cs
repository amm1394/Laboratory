...
{
    public partial class DeliveryDateChangeOnSiteTesting : RASF.General.Forms.Base.DockContentForm
    {

        public DeliveryDateChangeOnSiteTesting()
        {
            InitializeComponent();
            this.deliveryDateChangeList1.spName = "DeliveryDateChangeOnSiteTesting";
