...
{
    public static class OldMakePicture2
    {
        ...
        public static RASF.General.Data.GetDocumentForPrint MakePage(Guid PartsTestMasterCode,Boolean RType,String LabType,String ManageName,String EnglishManageName)
        {
            ...
            if (RType == false)
            {
                ...
                Parameters.Add(new System.Data.SqlClient.SqlParameter("@FileName", "http://reports.razi-foundation.com/Pershian Template/Main/OldTemplatePic.docx"));
            ...
            RASF.General.Lists.ReportPart_Pic2List Part_Pics_List = new Lists.ReportPart_Pic2List();
