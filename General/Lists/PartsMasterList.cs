...
namespace RASF.General.Lists
{
    ...
    public class PartsMasterList : RASF.General.Lists.Base.BaseList<RASF.General.Data.Parts_Master>
    {
        Int16 PartNumber = -1;
        public PartsMasterList()
        {
            this.spName = "Parts_Master";
            this.list = new List<RASF.General.Data.Parts_Master>();
            this.deletedlist = new List<RASF.General.Data.Parts_Master>();
        }

        public PartsMasterList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
        ...
        {
            foreach (RASF.General.Data.Parts_Master test in this)
            {
        ...
        public Int16 TotalPrice()
        {
            ...
            foreach (RASF.General.Data.Parts_Master parts in this)
            {
        ...
        public Int16 GetPartNumber(Guid ContractsBaseCode)
        {
            if (PartNumber == -1)
            {
                ...
                {
                    using (System.Data.SqlClient.SqlCommand Command = new System.Data.SqlClient.SqlCommand("GetPartNumber", Connection))
                    {
