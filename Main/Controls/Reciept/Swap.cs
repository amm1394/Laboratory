...
{
    public partial class Swap : UserControl, RASF.General.InterFaces.IRecieption
    {
        ...
        {
            return Insert_ReceiptAmount_Master.Update(CompanyId, 12, (Guid)drpCash.SelectedValue, Convert.ToInt32(nbReceiptAmount.Value.ToString()));
        }
