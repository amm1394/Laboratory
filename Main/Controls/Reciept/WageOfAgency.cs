...
{
    public partial class WageOfAgency : UserControl, RASF.General.InterFaces.IRecieption
    {
        ...
        {
            return Insert_ReceiptAmount_Master.Update(CompanyId, 9, (Guid)drpCash.SelectedValue, Convert.ToInt32(nbReceiptAmount.Value.ToString()));
        }
