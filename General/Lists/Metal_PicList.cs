...
namespace RASF.General.Lists
{
    ...
    public class Metal_PicList : RASF.General.Lists.Base.BaseList<RASF.General.Data.Metal_Pic>
    {
        public Metal_PicList()
        {
            this.spName = "Metal_Pic";
            this.list = new List<RASF.General.Data.Metal_Pic>();
            this.deletedlist = new List<RASF.General.Data.Metal_Pic>();
        }

        public Metal_PicList(System.ComponentModel.IContainer container)
            : this()
        {
            container.Add(this);
        }
