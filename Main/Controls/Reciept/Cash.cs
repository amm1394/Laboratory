...
{
    public partial class Cash : UserControl, RASF.General.InterFaces.IRecieption
    {
        ...
        {
            return Insert_ReceiptAmount_Master.Update(CompanyId, 1, (Guid)drpCash.SelectedValue, Convert.ToInt32(nbReceiptAmount.Value.ToString()));
        }
        ...
        {
            if (Total <= Convert.ToInt32(this.nbReceiptAmount.Value) && Convert.ToInt32(this.nbReceiptAmount.Value)>0)
            {
                return true;
            }
            else
