...
{
    public partial class MoneyOrder : UserControl, RASF.General.InterFaces.IRecieption
    {
        ...
        public void ShowReport(Guid ReceiptAmountMasterCode, Boolean InformalReceipt)
        {
            ...
            {
                this.Insert_ReceiptAmount_Master.ShowReport(ReceiptAmountMasterCode, String.Format("{0}\\Report\\ReceiptofMoneyOrder.mrt", Application.StartupPath));
            }
            else
            {
                this.Insert_ReceiptAmount_Master.ShowReport(ReceiptAmountMasterCode, String.Format("{0}\\Report\\ReceiptofMoneyOrder-Informal.mrt", Application.StartupPath));
        ...
        {
            Guid ReceiptAmount_Master = Insert_ReceiptAmount_Master.Update(CompanyId, 3, (Guid)drpCash.SelectedValue, Convert.ToInt64(nbReceiptAmount.Value.ToString()));
        ...
        {
            if ((Total <= Convert.ToInt64(this.nbReceiptAmount.Value)) && (String.IsNullOrWhiteSpace(txtMoneyOrderNo.Text) == false) && (DatePickerMoneyOrder.IsNull == false))
            {
                return true;
            }
            else
        ...
        private void txtMoneyOrderNo_Leave(object sender, EventArgs e)
        {
            ...
            Parameter1.Add(new System.Data.SqlClient.SqlParameter("AssignmentNo", String.Format("{0}", this.txtMoneyOrderNo.Text)));
            string Assno1 = (string)RASF.General.Lists.BanksList.FillScalar("FindAssignmentNo2_Select", Parameter1);
            string Asstxt1 = this.txtMoneyOrderNo.Text;
