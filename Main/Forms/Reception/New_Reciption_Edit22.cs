...
{
    public partial class New_Reciption_Edit22 : RASF.Main.Forms.Reception.New_Reception22
    {
        private Int16 ContractNo;
        public New_Reciption_Edit22(Guid contractid)
        {
            InitializeComponent();
        ...
        private void New_Reciption_Edit_Load(object sender, EventArgs e)
        {
           // txtReson.Enabled = true;
            ...
            foreach (RASF.General.Data.Parts_Master Parts in this.parts_Master_DeclareCostList1.list)
            {
