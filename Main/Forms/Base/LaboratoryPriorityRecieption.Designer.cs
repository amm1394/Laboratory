...
{
    partial class LaboratoryPriorityRecieption
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LaboratoryPriorityRecieption));
            ...
            this.masterTestPriorityRecList1 = new RASF.General.Lists.MasterTestPriorityRecList(this.components);
            ...
            this.mainTestPriorityRecList1 = new RASF.General.Lists.MainTestPriorityRecList(this.components);
            this.grpDetail = new RASF.General.Controls.GroupBox();
            this.grdDetail = new RASF.General.Controls.Grid();
            this.detailTestList1 = new RASF.General.Lists.DetailTestList(this.components);
            ...
            this.mainTestStatusList1 = new RASF.General.Lists.MainTestStatusList(this.components);
            ...
            // grdlaboratory
            // 
            this.grdlaboratory.AllowAddNew = Janus.Windows.GridEX.InheritableBoolean.True;
            ...
            // grdMaster
            // 
            this.grdMaster.AllowAddNew = Janus.Windows.GridEX.InheritableBoolean.True;
            ...
            this.grdMaster.DataSource = this.masterTestPriorityRecList1;
            ...
            // grdMain
            // 
            this.grdMain.AllowAddNew = Janus.Windows.GridEX.InheritableBoolean.True;
            ...
            this.grdMain.DataSource = this.mainTestPriorityRecList1;
            ...
            // grdDetail
            // 
            this.grdDetail.AllowAddNew = Janus.Windows.GridEX.InheritableBoolean.True;
            ...
            this.grdDetail.DataSource = this.detailTestList1;
            ...
            this.grdDetail.Size = new System.Drawing.Size(593, 272);
        ...
        private General.Lists.MasterTestPriorityRecList masterTestPriorityRecList1;
        private General.Lists.MainTestPriorityRecList mainTestPriorityRecList1;
        private General.Lists.MainTestStatusList mainTestStatusList1;
        private General.Lists.DetailTestList detailTestList1;
    }
}
