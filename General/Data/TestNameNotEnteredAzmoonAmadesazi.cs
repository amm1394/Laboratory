...
{
     public class TestNameNotEnteredAzmoonAmadesazi : RASF.General.InterFaces.IRow
    {
         ...
         [System.ComponentModel.Category("RASF")]
         [RASF.General.Attributes.DataAttribute()]
         public Guid TestExecutersCodeEnter
         {
             get;
             set;
         }
        ...
        [System.ComponentModel.Category("RASF")]
        [RASF.General.Attributes.DataAttribute()]
        public DateTime DateOfTestString
        {
            get;
            set;
        }
        ...
        public TestNameNotEnteredAzmoonAmadesazi()
        {
